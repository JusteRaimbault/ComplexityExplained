...
Les systèmes complexes consistent en de nombreuses composantes en interaction mutuelle et avec leur environnement, de multiples façons.
}
...
Système, composante, interactions, réseau, structure, hétérogénéité, interrelation, connectivité, interdépendance, sous-systèmes, limites, environnement, systèmes ouverts/fermés, systèmes de systèmes. 
}
...
Les systèmes complexes ont tendance à changer leur états de manière dynamique, présentant souvent des comportements non-prédictibles à long terme.
}
...
Dynamiques, comportement, non-linéarité, chaos, non-équilibre, sensibilité, effet papillon, bifurcation, non-predictabilité à long-terme, incertitude, dépendance au chemin/contexte, non-ergodicité.
}
...
Apprentissage, adaptation, évolution, \textit{fitness}, robustesse, résilience, diversité, systèmes complexes adaptatifs, algorithmes génétiques, vie artificielle, intelligence artificielle, intelligence collective, créativité, \textit{open-endedness}
}
...
Universalité, applications, multi/inter/trans-disciplinarité, économie, société, culture, écosystèmes, durabilité, prise de décision.
}
...
Les méthodes mathématiques et computationnelles sont des outils puissants pour étudier les systèmes complexes.
}
...
Modélisation, simulation, analyse de données, méthodologie, modèles multi-agents, analyse de réseaux, théorie des jeux, visualisation, règles, compréhension.
}
